...
const translations = {
  pt: {
    ...
    resultsHoldingReduction: 'Reduções por prazo de detenção (OE2024)',

    resultsHoldingReductionToggle: 'Aplicar reduções por prazo de detenção',
    resultsHoldingReductionWarning: '⚠️ Estas reduções podem aplicar-se apenas a actions de micro/PME. Confirme com um TOC/ROC antes de as aplicar na sua declaração.',
...
23. Clique em "Submeter" e guarde o comprovativo (PDF) para os seus registos.
  ...
  en: {
    ...
    resultsHoldingReduction: 'Holding period reductions (OE2024)',
    resultsHoldingReductionToggle: 'Apply holding period reductions',
    resultsHoldingReductionWarning: '⚠️ These reductions may only apply to shares in micro/SME companies. Confirm with a certified accountant (TOC/ROC) before applying them to your declaration.',
