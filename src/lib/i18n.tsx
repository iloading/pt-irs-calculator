...
const translations = {
  pt: {
    ...
    resultsHoldingReduction: 'Reduções por prazo de detenção (CIRS art. 43, n.º 5)',

    resultsHoldingReductionToggle: 'Aplicar reduções por prazo de detenção',
    resultsHoldingReductionWarning: 'Exceção: se deteve as ações menos de 365 dias E o seu rendimento coletável for ≥ €83.696 (ultimo escalão IRS), estas reduções não se aplicam (CIRS art. 43, n.º 5).',
    monetaryCorrectionTitle: 'Correção monetária (CIRS art. 50)',
    monetaryCorrectionToggle: 'Aplicar correção monetária',
    monetaryCorrectionExplain: 'Para "partes sociais" (ações de uma empresa) detidas há mais de 24 meses, o custo de aquisição é corrigido por um coeficiente de desvalorização da moeda publicado anualmente (Portaria), antes de calcular a mais-valia.',
    monetaryCorrectionScopeNote: '⚠️ Aplica-se apenas a ações/partes sociais de empresas — NÃO se aplica a unidades de participação de fundos/ETFs, obrigações ou outros valores mobiliários que não sejam partes sociais.',
    monetaryCorrectionYearWarning: (year: number) => `A tabela de coeficientes disponível nesta app é a publicada para alienações em 2025 (Portaria n.º 382/2025/1). Para o ano fiscal ${year}, a correção monetária não pode ser aplicada com precisão — os valores abaixo assumem coeficiente 1 (sem correção).`,
    monetaryCorrectionUplift: 'Correção monetária (custo ajustado)',
    assetClassificationLabel: 'Classificação',
    assetClassificationShare: 'Ações / partes sociais',
    assetClassificationFund: 'Fundo / ETF',
    assetClassificationHint: 'Determina se a correção monetária (art. 50.º) pode aplicar-se a este ativo. Verifique — a deteção automática é apenas uma sugestão.',
    resultsLotCoefficient: 'Coeficiente',
    resultsLotCorrectedCost: 'Custo corrigido',
...
23. Clique em "Submeter" e guarde o comprovativo (PDF) para os seus registos.
  ...
  en: {
    ...
    resultsHoldingReduction: 'Holding period reductions (CIRS art. 43, n.º 5)',
    resultsHoldingReductionToggle: 'Apply holding period reductions',
    resultsHoldingReductionWarning: 'Exception: if you held the shares for less than 365 days AND your taxable income is ≥ €83,696 (top IRS bracket), these reductions do not apply (CIRS art. 43, n.º 5).',
    monetaryCorrectionTitle: 'Monetary correction (CIRS art. 50)',
    monetaryCorrectionToggle: 'Apply monetary correction',
    monetaryCorrectionExplain: 'For "partes sociais" (shares in a company) held for more than 24 months, the acquisition cost is corrected by an annually-published monetary devaluation coefficient before computing the gain.',
    monetaryCorrectionScopeNote: '⚠️ Only applies to individual company shares — NOT to fund/ETF units, bonds, or other securities that aren\'t equity in a specific company.',
    monetaryCorrectionYearWarning: (year: number) => `The coefficient table available in this app is the one published for 2025 disposals (Portaria n.º 382/2025/1). For fiscal year ${year}, monetary correction cannot be applied accurately — figures below assume coefficient 1 (no correction).`,
    monetaryCorrectionUplift: 'Monetary correction (adjusted cost)',
    assetClassificationLabel: 'Classification',
    assetClassificationShare: 'Company shares',
    assetClassificationFund: 'Fund / ETF',
    assetClassificationHint: 'Determines whether monetary correction (art. 50) can apply to this asset. Please double-check — the automatic guess is only a suggestion.',
    resultsLotCoefficient: 'Coefficient',
    resultsLotCorrectedCost: 'Corrected cost',
